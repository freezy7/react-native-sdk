...
source_path = 'node_modules/react-native/Libraries/NativeAnimation'
...
Pod::Spec.new do |s|
  ...
  s.source                 = { :http => "https://github.com/freezy7/react-native-sdk/releases/download/v#{s.version}/React-RCTAnimation.zip" }
