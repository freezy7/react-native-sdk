...
let package = Package(
  ...
  targets: [
    .binaryTarget(
        ...
        url: "https://github.com/freezy7/react-native-sdk/releases/download/0.84.1/ReactNativeFramework-debug.xcframework.zip",
        checksum: "ba1be12c1e90bb361a465224609092c24f0bb78e5d4018ab517f823818e0e828"
    ),
    .binaryTarget(
        name: "hermesvm",
